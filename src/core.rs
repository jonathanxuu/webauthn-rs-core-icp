...
use crate::constants::AUTHENTICATOR_TIMEOUT;

use crate::crypto::compute_sha256;
use crate::error::WebauthnError;
use crate::internals::*;
use crate::proto::*;
use base64urlsafedata_icp::Base64UrlSafeData;
...
impl WebauthnCore {
    ...
    fn generate_challenge(&self) -> Challenge {
        ...
        // let rng: Vec<u8> = vec![65; 32];
        let current_time = ic_cdk::api::time();
        let random_value = ic_cdk::api::call::arg_data_raw();
        let combined = format!("{}{:?}", current_time, random_value);
        let hash = compute_sha256(combined.as_bytes());

        Challenge::new(hash.to_vec())
    }
...
mod tests {
    ...
    fn register_userid(
        ...
        wan.generate_challenge_register(&user_unique_id.to_owned(), name, display_name, policy)
    }
