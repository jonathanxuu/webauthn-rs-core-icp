...
use crate::error::*;
use std::fmt;
use webauthn_rs_proto_icp::cose::*;
use webauthn_rs_proto_icp::extensions::*;
use webauthn_rs_proto_icp::options::*;
...
pub struct SerialisableAttestationCa {
    ...
    pub(crate) aaguids: BTreeSet<[u8; 16]>,
}
